 ...
 */
export const createUser = async (userDto: Partial<User>) => {
...
export const updateUser = async (updateUserDto) => {
    ...
    const { id, firstName, lastName, password, about,  profileImage, updated } = updateUserDto
